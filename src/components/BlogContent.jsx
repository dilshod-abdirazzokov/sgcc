...
const BlogContent = () => {
        ...
        const blog=[
        {
            ...
            'authorName':'John Doe',
            'authorImg' :"https://i.pinimg.com/236x/71/6c/f7/716cf7bfccac858987ed9dd43c020fe9.jpg",
        ...
        md:gap-x-8 sm:gap-y-8 ss:gap-y-8 px-4 sm:pt-20 md:mt-0 ss:pt-20 text-black'>
            ...
            <div className='items-center w-full bg-white rounded-xl drop-shadow-md py-5 max-h-[250px]'>
                <div>
                    ...
                    <h1 className='font-bold text-2xl text-center text-gray-900 pt-3'>{blog.authorDesc}</h1>
                    <p className='text-center text-gray-900 font-medium'>{blog.authorName}</p>
                </div>
            </div>
